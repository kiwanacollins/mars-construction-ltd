<?php $page_title = "Blog Classic"; $home = false; ?>
<?php
						...
						<div class="news-block_two">
							<div class="news-block_two-inner">
								<div class="news-block_two-image">
									<a href="blog-detail.php?slug=<?php echo urlencode($post['slug']); ?>"><img src="<?php echo htmlspecialchars($post['featured_image'] ?: 'assets/images/resource/news-10.jpg'); ?>" alt="" /></a>
								</div>
								<div class="news-block_two-content">
									<ul class="news-block_two-meta d-flex align-items-center flex-wrap">
										<li><span class="icon"><img src="assets/images/icons/user.svg" alt="" /></span>Admin</li>
										<li><span class="icon"><img src="assets/images/icons/comment.svg" alt="" /></span><?php echo htmlspecialchars(date('d M, Y', strtotime($post['published_at'] ?: $post['created_at']))); ?></li>
									</ul>
									<h3 class="news-block_two-heading"><a href="blog-detail.php?slug=<?php echo urlencode($post['slug']); ?>"><?php echo htmlspecialchars($post['title']); ?></a></h3>
									<div class="news-block_two-text"><?php echo htmlspecialchars($post['excerpt'] ?: mb_strimwidth(strip_tags($post['body'] ?? ''), 0, 200, '...')); ?></div>
									<a class="news-block_two-more" href="blog-detail.php?slug=<?php echo urlencode($post['slug']); ?>">read more</a>
								</div>
							</div>
						</div>
					<?php endforeach; ?>
